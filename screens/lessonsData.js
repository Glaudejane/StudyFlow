...
export const lessonsData = {
    ...
    semana_18: {
        ...
        content:
            "Muitos verbos essenciais na programação exigem uma preposição específica para fazerem sentido em inglês. Por exemplo, nós fazemos o upload de algo PARA um lugar ('upload TO'), baixamos DE algum lugar ('download FROM'), clicamos EM algo ('click ON') e nos inscrevemos EM um serviço ('subscribe TO'). Usar essas combinações perfeitamente evita erros ao documentar códigos ou criar prompts.",
        iaInsight:
        ...
        quiz: {
            question:
                "Você quer que a IA crie um botão para o seu app React Native. O objetivo é que, ao clicar, o app envie o arquivo de log para o servidor. Qual frase está gramaticalmente correta?",
            options: [
            ...
            correctId: "B",
            explanation:
                "Perfeito! O verbo 'upload' exige a preposição 'to' para indicar o destino do envio dos dados ('upload to the server'). O 'from' seria usado se estivéssemos baixando (downloading) o arquivo.",
        },
    },
    ...
    semana_19: {
        ...
        content:
            "Phrasal Verbs são combinações de um verbo com uma preposição que, juntos, ganham um significado totalmente novo. Na TI, o grupo com 'In/Out/On/Off' gerencia acessos e estados: 'Log in / Sign in' (entrar no sistema), 'Log out / Sign out' (sair do sistema), 'Turn on' (ligar/ativar um componente como a câmera) e 'Turn off' (desligar/desativar).",
        iaInsight:
        ...
        quiz: {
            question:
                "Como você pede para a IA criar uma lógica de chaves (Toggles) para ativar ou desativar as notificações do aplicativo?",
            options: [
            ...
            correctId: "B",
            explanation:
                "Sensacional! 'Turn on' e 'Turn off' são as expressões corretas para ligar/ativar e desligar/desativar componentes eletrônicos, funções de software ou estados de chaves de configuração (toggles).",
        },
    },
    ...
    semana_20: {
        ...
        quiz: {
            question:
                "Você terminou o seu aplicativo e quer que a IA te ajude a criar um guia de como configurar todo o ambiente do projeto no computador de outra pessoa. Qual termo você deve usar?",
            options: [
            ...
            correctId: "B",
            explanation:
                "Parabéns! 'Set up' é o phrasal verb padrão na tecnologia para se referir à instalação, preparação e configuração inicial de qualquer sistema, software ou ambiente de desenvolvimento!",
        },
    },
};
